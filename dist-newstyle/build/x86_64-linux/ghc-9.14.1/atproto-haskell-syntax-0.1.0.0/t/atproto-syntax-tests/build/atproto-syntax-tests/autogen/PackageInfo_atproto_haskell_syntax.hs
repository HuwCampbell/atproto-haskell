...
{-|
Module      : PackageInfo_atproto_haskell_syntax
...
synopsis :: String
synopsis = "AT Protocol identifier syntax: DIDs, handles, NSIDs, AT URIs, TIDs, record keys"
