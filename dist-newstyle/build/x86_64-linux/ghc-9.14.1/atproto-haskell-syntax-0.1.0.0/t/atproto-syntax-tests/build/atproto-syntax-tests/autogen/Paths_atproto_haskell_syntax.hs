...
{-|
Module      : Paths_atproto_haskell_syntax
...
-- at runtime using the environment variable atproto_haskell_syntax_bindir.
...
-- environment variable atproto_haskell_syntax_libdir.
...
-- using the environment variable atproto_haskell_syntax_dynlibdir.
...
-- runtime using the environment variable atproto_haskell_syntax_datadir.
...
-- variable atproto_haskell_syntax_libexedir.
...
-- using the environment variable atproto_haskell_syntax_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3/atproto-haskell-syntax-0.1.0.0-inplace-atproto-syntax-tests"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.14.1-c6c3/atproto-haskell-syntax-0.1.0.0"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.14.1-c6c3/atproto-haskell-syntax-0.1.0.0"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "atproto_haskell_syntax_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "atproto_haskell_syntax_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "atproto_haskell_syntax_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "atproto_haskell_syntax_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "atproto_haskell_syntax_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "atproto_haskell_syntax_sysconfdir") (\_ -> return sysconfdir)
